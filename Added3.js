...
export default class Added3 extends Component {
  ...
  constructor(){
    ...
    this.itemsRef = this.getRef().child('stock');
...
componentDidMount(){
 ...
 this.setState({
  itemDataSource: this.state.itemDataSource.cloneWithRows(stock)
...
<Modal
      ...
      style={{marginTop:50,}}
        value={this.state.text}
          ...
          />
          <Text style={{textAlign:'center'}}>E.g Biscuit (5 Cartoons) or Sugar (2 Bags)</Text>
